...
Po co powstalo: bo pliki w chmurze jak już sa tam wrzucone to nie mogą być modyfikowane (cloud storage jest immutable). Stanowi podstawe dla time-travel, secure data sharing i cloning.
...
Data (all tables) in Snowflake is automatically organized into partitions known as micro partitions.
