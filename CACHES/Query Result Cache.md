...
Query Result Cache jest integralną częścią warstwy **Cloud Services**. 

Oto dlaczego to powiązanie jest tak istotne:
...
### poziomy na ktorych mozna wylaczyc query result cache
...
### Dlaczego nie poziom Tabeli?

To jest klucz do zrozumienia architektury:

1. **Cache jest "ponad" tabelami:** Result Cache nie wie, że "należy" do tabeli A czy B. On przechowuje wynik konkretnego **tekstu zapytania SQL**. Jedno zapytanie może łączyć 10 tabel. 
